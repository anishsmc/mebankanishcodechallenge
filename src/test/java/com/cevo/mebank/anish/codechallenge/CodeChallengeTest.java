...
public class CodeChallengeTest {
    ...
    void testCreateTransaction(){
        ...
        Assertions.assertEquals(850l, CodeChallenge.createTransactionFromInput(input).getAmountInCents());
    }
    ...
    void testUserInputToCalculator(){
        ...
        Assertions.assertEquals("The Relative Balance for this period is $2.15 and the Number of Transactions included is: 2", CodeChallenge.calculateAndGetOutputOnUserInput(consoleInput, rbc));
    }
}
