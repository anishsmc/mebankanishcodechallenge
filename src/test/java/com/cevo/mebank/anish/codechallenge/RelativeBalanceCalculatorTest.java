...
public class RelativeBalanceCalculatorTest {
    ...
    static void setupTransactionList(){
        transactionList.add(new Transaction("TX10003", "ACC998877", "ACC778899", "20/10/2018 18:00:00", "8.50", "PAYMENT"));
        transactionList.add(new Transaction("TX10003", "ACC998877", "ACC778899", "20/10/2018 18:30:00", "12.75", "PAYMENT"));
